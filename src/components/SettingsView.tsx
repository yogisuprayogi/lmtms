      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6 lg:col-span-1">
          ...
          <div className="bg-white p-6 border border-slate-200 rounded-2xl shadow-sm text-center">
            <div className="inline-flex h-20 w-20 rounded-full bg-blue-50 border-4 border-blue-100 items-center justify-center text-blue-600 font-bold text-3xl mb-4">
              {user.nama.charAt(0)}
            </div>
